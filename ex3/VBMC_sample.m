...
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {fullfile(pwd,'stats')};
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.name = '<UNDEFINED>';
...
matlabbatch{4}.spm.stats.factorial_design.dir(1) = cfg_dep('Make Directory: Make Directory ''<UNDEFINED>''', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','dir'));
%%
matlabbatch{4}.spm.stats.factorial_design.des.t2.scans1 = {
                                                           fullfile(pwd,'NDB/swc1V_0040013.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040014.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040017.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040018.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040019.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040020.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040023.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040024.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040026.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040027.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040030.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040031.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040033.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040035.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040036.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040038.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040043.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040045.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040048.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040050.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040051.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040052.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040053.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040054.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040055.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040056.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040057.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040058.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040061.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040063.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040065.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040066.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040067.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040068.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040069.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040076.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040086.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040087.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040090.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040091.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040093.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040095.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040102.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040104.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040107.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040111.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040113.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040114.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040115.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040116.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040119.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040120.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040121.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040123.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040124.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040125.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040127.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040128.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040129.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040130.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040131.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040134.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040135.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040136.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040138.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040139.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040140.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040141.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040144.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040146.nii,1')
                                                           fullfile(pwd,'NDB/swc1V_0040147.nii,1')
                                                           };
%%
...
matlabbatch{4}.spm.stats.factorial_design.masking.em = {fullfile(pwd,'mask/mask.nii,1')};
...
matlabbatch{6}.spm.stats.con.consess{1}.tcon.name = 'NDB > Subject';
...
matlabbatch{8}.spm.util.render.display.rendfile = {fullfile(spm('dir'),'rend/render_spm96.mat')};
matlabbatch{8}.spm.util.render.display.conspec.spmmat(1) = cfg_dep('Contrast Manager: SPM.mat File', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
